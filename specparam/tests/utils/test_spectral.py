...
def test_interpolate_spectrum():
    ...
    freqs, powers = sim_power_spectrum(\
        [1, 75], [1, 1], 'fixed', [[10, 0.5, 1.0], [60, 2, 0.1]], 'gaussian')
    ...
    freqs, powers = sim_power_spectrum([1, 150], \
        [1, 100, 1], 'knee', [[10, 0.5, 1.0], [60, 1, 0.1], [120, 0.5, 0.1]], 'gaussian')
...
def test_interpolate_spectra():
    ...
    freqs, powers = sim_group_power_spectra(\
        5, [1, 150], [1, 100, 1], 'knee',
        [[10, 0.5, 1.0], [60, 1, 0.1], [120, 0.5, 0.1]], 'gaussian')
...
def test_subsample_spectra():
    ...
    freqs, powers = sim_group_power_spectra(n_sim, [1, 50], [1, 1], 'fixed', oscs, 'gaussian')
