...
#     tfm = SpectralModel(verbose=False)
#     file_name_res = 'test_res' # TOCHECK - 'test_model_res'
...
#     tfm = SpectralModel(verbose=False)
#     file_name_set = 'test_set' # TOCHECK - 'test_model_set'
...
#     tfm = SpectralModel(verbose=False)
#     file_name_dat = 'test_dat' # TOCHECK - 'test_model_dat'
...
#     tfm = SpectralModel(verbose=False)
#     file_name_all = 'test_all' # TOCHECK - 'test_model_all'
