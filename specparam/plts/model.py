...
def plot_model(model, plot_peaks=None, plot_aperiodic=True, freqs=None, power_spectrum=None,
    ...
    **plot_kwargs
    ...
    if model.data.has_data or custom_spectrum:
        ...
        plot_spectra(freqs if custom_spectrum else model.data.freqs,
                     power_spectrum if custom_spectrum else model.data.power_spectrum,
    ...
    if model.has_model:
        ...
        plot_spectra(model.data.freqs, model.modeled_spectrum_,
        ...
        if plot_aperiodic:
            ...
            plot_spectra(model.data.freqs, model._ap_fit,
...
def _add_peaks_shade(model, plt_log, ax, **plot_kwargs):
    ...
    **plot_kwargs
    ...
    for peak in model.gaussian_params_:
        ...
        peak_line = model._ap_fit + gen_periodic(model.data.freqs, peak)
...
def _add_peaks_dot(model, plt_log, ax, **plot_kwargs):
    ...
    **plot_kwargs
    ...
    for peak in model.peak_params_:
        ...
        ap_point = np.interp(peak[0], model.data.freqs, model._ap_fit)
